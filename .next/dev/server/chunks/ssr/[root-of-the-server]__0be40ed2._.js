...
function Home() {
    ...
    const [translated, setTranslated] = (0, __TURBOPACK__imported__module__$5b$externals$5d2f$react__$5b$external$5d$__$28$react$2c$__cjs$29$__["useState"])("");
    ...
    const translateText = async ()=>{
        const res = await fetch(`/api/translate?text=${encodeURIComponent(text)}&target=${lang}`);
