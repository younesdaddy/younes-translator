...
"[project]/pages/api/adminAction.js [api] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function handler(req, res) {
    ...
    if (password !== "Younesgdom") return res.status(401).json({
        error: "Unauthorized"
    });
    if (!action || !item) return res.status(400).json({
        error: "Missing action or item"
    });
    try {
        const normalizedOriginal = normalize(item.original);
        const normalizedTranslation = item.user_translation.trim();
        if (action === "approve") {
            await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$js__$5b$api$5d$__$28$ecmascript$29$__["supabaseAdmin"].from("pendingcorrection").delete().match({
                original: normalizedOriginal,
                user_translation: normalizedTranslation
            });
            await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$js__$5b$api$5d$__$28$ecmascript$29$__["supabaseAdmin"].from("approvedcorrection").insert([
                {
                    original: normalizedOriginal,
                    user_translation: normalizedTranslation
                }
...
//# sourceMappingURL=%5Broot-of-the-server%5D__a5cc7c27._.js.map